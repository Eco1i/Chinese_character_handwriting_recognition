...
tf.app.flags.DEFINE_integer('max_steps', 80000, 'the max training steps ')
...
tf.app.flags.DEFINE_string('train_data_dir', '../data/src/', 'the src dataset dir')
...
tf.app.flags.DEFINE_string('mode', 'src', 'Running mode. One of {"src", "valid", "test"}')
...
def train():
    ...
    with tf.Session() as sess:
        ...
        train_writer = tf.summary.FileWriter(FLAGS.log_dir + '/src', sess.graph)
